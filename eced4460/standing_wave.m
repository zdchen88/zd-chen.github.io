% This program illustrates the incident, reflected and standing waves on a
% transmission line of R, L, G, C at the frequency of f and terminated with
% a load of ZL.
% Four animations are shown in the figure: the top one is the incident
% voltage, the second from the top top is the refelcted voltage, the second
% from the bottom is the total voltage (combined incident and reflected voltage
% waves). The bottom one is the total current (combined incident and
% reflected currents).
R=0.;
L=1.0;
G=0.;
